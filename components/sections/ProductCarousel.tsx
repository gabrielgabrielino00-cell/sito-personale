                ...
                >
                  ...
                  <div className="border-t border-gray-50 p-5 dark:border-white/5">
                    ...
                    <div className="product-swap-cta flex flex-col gap-2">
                      ...
                      <button className="flex items-center justify-center gap-2 rounded-lg border border-gray-200 px-4 py-2.5 text-sm font-medium text-gray-600 transition-colors hover:border-brand hover:text-brand dark:border-white/10 dark:text-gray-400 dark:hover:border-brand dark:hover:text-brand">
